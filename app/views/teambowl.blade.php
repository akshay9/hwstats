				...
				<tr>
					...
					{ 
						...
						echo "<td 
							...
							<b>Age:</b> ".$age."<br>
							<b>SI:</b> ".$row->SI."<br>
							<b>Bowling Style:</b> ".$row->bowl_type."<br>\" >".$row->name."</td>" ; 
					}
					else
					{
						echo "<td></td>";
					...
					<td>{{ $row->pitch }}</td>
					<td><span  data-toggle="tooltip" data-placement="bottom" title="Updated at: {{ $row->updated_at }}" class="stars" style="width:{{ ($row->rating)*20 }}px"></span></td>
				</tr>
				@endif
